...
<body>
  ...
  $(function(){
    $('#id_kategoriprodukaa').on('change', function(){
      let id_kategoriproduk = $('#id_kategoriprodukaa').val();
			console.log(id_kategoriproduk);
      $.ajax({
        type : 'POST',
        url : "{{ url('getprodukbykategori') }}",
        data : {
          "id_kategoriproduk": id_kategoriproduk,
					"_token": '{{ csrf_token() }}'
        },
        cache : false,
        success : function(msg){
          console.log(msg);
					// $('#tablepilihproduk').html(msg);
					$('tbody#pilihproduk').html(msg);
        },
        error : function(data){
	...
	$(function() {
		$('table#pilihproduk').on("click", "tr.table-tr", function() {
			// id_produk = $(this).data("url");
			// alert($(this).data("url"));
			// alert(id_produkpilihan);
      $.ajax({
        type : 'POST',
        url : "{{ url('getprodukbykategorilagi') }}",
        data : {
          "id_produk": $(this).data("url"),
					"_token": '{{ csrf_token() }}'
        },

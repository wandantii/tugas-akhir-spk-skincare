    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        ...
        <!-- <div class="card-body"> -->
          ...
          <!-- <a href="{{ url('admin/kriteria/create') }}" type="button" class="btn btn-rounded btn-primary">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Datatable - Kriteria</h4>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table id="example" class="display" style="min-width:845px;font-weight: lighter;">
                <thead>
                  <tr>
                    <th>No</th>
                    <th>Nama</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
											  <a href="{{ url('admin/kriteria/'.$value->id_kriteria.'/edit') }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                        <!-- <form action="{{ url('admin/kriteria/'.$value->id_kriteria.'/') }}" method="POST" onsubmit="return confirm('Anda yakin ingin menghapus data ini?')">
                          @csrf

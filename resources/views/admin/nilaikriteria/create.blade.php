      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Tambah Nilai Kriteria</h4>
          </div>
          <div class="card-body">
            <div class="basic-form">
              <form method="POST" action="{{ url('admin/nilaikriteria') }}">
                @csrf
                <div class="row">
                  <div class="col-sm mb-3">
                    ...
                    <select class="default-select form-control wide" id="id_kriteria" name="id_kriteria">
                      ...
                      <option value="{{ $kriteria->id_kriteria }}">{{ $kriteria->nama }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('nilai') is-invalid @enderror" name="nilai" id="nilai" value="{{ old('nilai') }}" required>
                    @error('nilai')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>

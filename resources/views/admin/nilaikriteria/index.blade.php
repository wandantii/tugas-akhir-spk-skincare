    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="{{ url('admin/nilaikriteria/create') }}" type="button" class="btn btn-rounded btn-primary">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Datatable - Nilai</h4>
          </div>
          <div class="card-body">
              ...
              <table id="example" class="display" style="min-width: 845px">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
											  <a href="{{ url('admin/nilaikriteria/'.$value->id_nilai.'/edit') }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                        <form action="{{ url('admin/nilaikriteria/'.$value->id_nilai.'/') }}" method="POST" onsubmit="return confirm('Anda yakin ingin menghapus data ini?')">
                          @csrf

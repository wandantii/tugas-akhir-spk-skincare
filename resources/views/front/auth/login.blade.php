            ...
            <div class="auth-form" style="padding:50px 75px;">
              ...
              <form method="POST" action="{{ url('login') }}">
                ...
                <div class="mt-3">
                  ...
                  <input type="text" class="form-control @error('username') is-invalid @enderror" value="{{ old('username') }}" id="username" name="username" autofocus required>
                  @error('username')
              ...
              <div class="new-account mt-3">
                <p>Don't have an account? <a class="text-primary" href="{{ url('register') }}"><b>Register</b></a></p>
              </div>
            </div>
          </div>
        </div>
